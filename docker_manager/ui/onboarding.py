...
class OnboardingManager:
    ...
    def show_welcome(self) -> None:
        ...
        print("- You can generate system health reports")
        print()
    ...
    def _show_containers_help(self) -> None:
        ...
        print("- inspect: View container details")
        print()
    ...
    def show_help_browser(self) -> None:
        ...
        while True:
            ...
            print("5 - Administrative Privileges")
            print("6 - Demo Mode")
    ...
    def maybe_show_suggestion(self, context: str, action: Optional[str]) -> tuple:
        ...
        suggestions = {
            ...
            "container_inspect": (
                not self.is_topic_completed("containers"),
                "Tip: Container inspection shows detailed configuration and state."
            ),
    ...
    def _show_menu_help(self) -> None:
        """Show help for the main menu."""
        print_section("Main Menu")
        print("The main menu provides access to all Docker Service Manager features:")
        print("\nAvailable sections:")
        print("- service: Manage Docker service (start, stop, restart, etc.)")
        print("- socket: Manage Docker socket")
        print("- containers: List and manage Docker containers")
        print("- info: View Docker system information")
        print("- health: Generate system health report")
        print("- version: Show tool version")
        print("\nNavigation:")
        print("- Use arrow keys to move between options")
        print("- Press Enter to select an option")
        print("- Press 'q' to quit")
        print("- Press '?' for context-specific help")
        print("- Press 'h' to browse all help topics")

    def _show_section_help(self, section: str) -> None:
        """Show help for a specific section."""
        help_content = {
            "service": (
                "Docker Service Management",
                "Manage the Docker daemon service on your system.\n\n"
                "Available commands:\n"
            ...
            "socket": (
                ...
                "Manage the Docker socket connection.\n\n"
                "Available commands:\n"
                "- status: Check socket status\n"
                "- start: Start the socket\n"
                "- stop: Stop the socket\n"
                "- enable: Enable socket at boot\n"
                "- disable: Disable socket at boot"
            ),
            "containers": (
                "Container Management",
        ...
        if section in help_content:
            title, content = help_content[section]
            print_section(title)
            print(content)
        else:
            print(f"No help available for section: {section}")
