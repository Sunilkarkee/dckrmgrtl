...
class HealthReport:
    ...
    def __init__(self, demo_mode: bool = False, cache_timeout: int = 60):
        ...
        self.client = None
        if not demo_mode and DOCKER_AVAILABLE:
            try:
    ...
    def generate_full_report(self) -> Tuple[bool, Optional[str]]:
        """Generate a comprehensive health report."""
        try:
            if self.demo_mode:
                print("[demo] Generating full health report in demo mode")
                return True, "Demo mode: Full health report would show detailed system metrics"
...
Total Images: {images}
            ...
            print(report)
            return True, "Health report generated successfully"
            
        except Exception as e:
            return False, f"Error generating full report: {str(e)}"

    def generate_quick_report(self) -> Tuple[bool, Optional[str]]:
        """Generate a quick summary report."""
        try:
            if self.demo_mode:
                print("[demo] Generating quick health report in demo mode")
                return True, "Demo mode: Quick health report would show basic metrics"
            ...
            containers_running = len(self.client.containers.list(filters={"status": "running"}))
...
Running Containers: {containers_running}
            ...
            print(report)
            return True, "Quick health report generated successfully"
            
        except Exception as e:
            return False, f"Error generating quick report: {str(e)}"